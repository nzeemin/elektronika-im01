...
INT_PTR CALLBACK AboutBoxProc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
        {
            ...
            _sntprintf(buffer, buffersize - 1, _T("ELEKTRONIKA-IM01 version %s revision %d"), _T(APP_VERSION_STRING), APP_REVISION);
    ...
    case WM_NOTIFY:
        ...
        {
            ::ShellExecute(NULL, _T("open"), _T("https://github.com/nzeemin/elektronika-im01"), NULL, NULL, SW_SHOW);
            break;
        }
        break;
    }
